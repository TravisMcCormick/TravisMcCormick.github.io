export const myStory: string[] = [
  ...
  "Right now, I'm working as an Embedded Cybersecurity Engineer @ EveryPeer. I build embedded agents, work on WebRTC based peer discovery systems, and contribute to backend stuff for network security. I'm ISC2 Certified in Cybersecurity and currently studying for my Network+ certification.",
...
export const education = [
  {
    ...
    date: "Graduated May 2025 | GPA: 3.25",
    focus: "Focus: Embedded Systems, Network Security, Hardware Security",
  },
  {
    degree: "High School Diploma",
    institution: "St. Cloud High School, St. Cloud, FL",
    date: "Graduated May 2021 | GPA: 3.7 (Unweighted), 4.3 (Weighted)",
    focus: "Competitive Swimmer | Varsity Team 2016-2021",
  },
];

export const certInProgress = {
  name: "CompTIA Network+",
  org: "CompTIA",
  date: "Currently Studying",
  desc: "Working on getting this one next. It covers networking concepts, infrastructure, network operations, and troubleshooting, all stuff I use at work anyway, so it makes sense to get certified.",
};
...
export const certs = [
  {
    ...
    desc: "Covers security principles, access controls, network security, and security operations. It's a good entry level cert that covers the fundamentals.",
  },
];
...
export const experience = [
  ...
  {
    role: "Chief of Staff",
    company: "Florida Polytechnic Cybersecurity Club",
...
export const interests = [
  {
    emoji: "🏊",
    title: "Swimming",
    body: "Competitive swimmer from 2016-2021. Still swim regularly for fitness and relaxation. It's where I learned discipline and how to push myself.",
  },
  {
    emoji: "🖨️",
    title: "3D Printing",
    body: "Got into it when I needed to print a case for my custom keyboard. Now I use it for all kinds of projects and prototyping.",
  },
  {
    emoji: "🎮",
    title: "Gaming",
    body: "Hollow Knight and Hollow Knight: Silksong are my favorite games. I never would've played them without my friend James pushing me to, but I'm glad he did.",
  },
  {
    emoji: "⚙️",
    title: "Engines & Mechanics",
  ...
  },
  {
    emoji: "🧩",
    title: "Puzzles",
    body: "I like all kinds of puzzles: Rubik's cubes, sudoku, star battles, you name it. There's something satisfying about working through a problem methodically until you solve it.",
  },
  {
    emoji: "🔍",
    title: "Reverse Engineering",
    body: "Taking things apart to understand how they work has always been fun for me. Whether it's firmware, binaries, or just figuring out how a system is built, I like the challenge of reverse engineering to see what's under the hood.",
  },
];
