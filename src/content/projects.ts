...
// Dates are each repo's first..last commit on GitHub; both lists run newest first.

export const featuredProjects: FeaturedProject[] = [
  {
    title: "Zettelkasten Knowledge Base",
    date: "October 17, 2024 – April 20, 2026",
    icon: Brain,
  ...
  },
  {
    ...
    date: "December 1, 2024 – January 29, 2026",
    icon: Keyboard,
    heading: "The Story Behind the Build",
    paragraphs: [
      "I've always been worried about working at a computer all day and what it might do over the long term. I already need glasses from staring at screens and reading books in bad lighting as a kid, so I figured I should be proactive about preventing carpal tunnel before it becomes a problem.",
  ...
  },
  {
    ...
    date: "February 19, 2025 – March 31, 2025",
    icon: CalendarBlank,
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    date: "August 16, 2023 – August 24, 2023",
    tags: ["C++"],
    icon: Timer,
    body: "A friendly and efficient desktop tool designed to streamline lifeguard rotation scheduling. Features real time information updates, dynamic stand management, threading for performance, and weather pause functionality.",
  ...
  },
  {
    ...
    date: "December 7, 2022 – December 14, 2022",
    tags: ["Algorithms"],
    icon: ChartLine,
